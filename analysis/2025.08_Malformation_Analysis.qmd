...
Gibbs.Pen.Lin.Reg_FN <- function(
  ...
  for(iter in 1:iters){
    ...
    xtx_plus_pen_old <- xtx_plus_pen * 1.0
    
    beta_expect_old <- beta_expect * 1.0
    
    beta_var_old <- beta_var * 1.0
    ...
    xtx_plus_pen_C <- xtx_plus_pen
    
    beta_expect_C <- beta_expect
    ...
    cat("xtx_pen R-C max diff:", max(abs(xtx_plus_pen - xtx_plus_pen_C)), "\n")
    cat("expect R-C max diff:", max(abs(beta_expect - beta_expect_C)), "\n")
    cat("var R-C max diff:", max(abs(beta_var - beta_var_C)), "\n")
