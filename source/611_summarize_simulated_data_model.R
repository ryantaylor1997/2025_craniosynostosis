...
save(gamma_newdata_df,
     file = here("data", "simulations", "hierarchical_gamma_df.rda"))
...
ggsave(here("results", "sim_plot_gamma_age.png"),
       gamma_curve_plot,
...
save(outcome_long_df,
     file = here("data", "simulations", "hierarchical_outcome_df.rda"))
...
ggsave(here("results", "sim_plot_outcome_age.png"),
